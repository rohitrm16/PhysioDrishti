...
function LogoMark({ size = 36 }) {
  return (
    <svg width={size} height={size * 0.88} viewBox="0 0 300 264" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="lgT" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%"   stopColor="#5DE87A"/>
          <stop offset="45%"  stopColor="#26C6A0"/>
          <stop offset="100%" stopColor="#0A7A6E"/>
        </linearGradient>
        <linearGradient id="lgP" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%"   stopColor="#42DDCC"/>
          <stop offset="55%"  stopColor="#0FA898"/>
          <stop offset="100%" stopColor="#07706A"/>
        </linearGradient>
      </defs>
      <circle cx="70"  cy="46"  r="22" fill="url(#lgT)"/>
      <path d="M 59,67 C 49,83 39,107 35,133 C 31,157 31,179 35,197 C 39,213 49,223 61,219 C 71,215 75,202 72,187 C 69,172 65,155 63,138 C 61,123 64,107 69,95" stroke="url(#lgT)" strokeWidth="26" strokeLinecap="round" fill="none"/>
      <path d="M 83,115 C 87,135 90,157 89,176 C 88,193 84,209 79,220" stroke="url(#lgT)" strokeWidth="22" strokeLinecap="round" fill="none"/>
      <path d="M 89,80 C 107,69 129,69 149,83 C 157,89 163,99 165,111" stroke="url(#lgT)" strokeWidth="22" strokeLinecap="round" fill="none"/>
      <circle cx="150" cy="94"  r="17" fill="url(#lgP)"/>
      <path d="M 141,111 C 136,130 132,151 130,171 C 128,189 129,205 134,217 C 138,226 147,228 153,224" stroke="url(#lgP)" strokeWidth="19" strokeLinecap="round" fill="none"/>
      <path d="M 159,111 C 164,130 168,151 170,171 C 172,189 171,205 166,217 C 162,226 153,228 147,224" stroke="url(#lgP)" strokeWidth="19" strokeLinecap="round" fill="none"/>
      <circle cx="230" cy="50"  r="20" fill="url(#lgT)"/>
      <path d="M 241,70 C 251,86 261,110 265,136 C 269,160 269,182 265,200 C 261,216 251,226 239,222 C 229,218 225,205 228,190 C 231,175 234,158 236,141 C 238,124 235,108 230,96" stroke="url(#lgT)" strokeWidth="24" strokeLinecap="round" fill="none"/>
      <path d="M 217,119 C 213,139 210,161 211,180 C 212,197 216,212 221,222" stroke="url(#lgT)" strokeWidth="20" strokeLinecap="round" fill="none"/>
      <path d="M 211,84 C 193,73 171,73 151,87 C 143,93 137,103 135,115" stroke="url(#lgT)" strokeWidth="20" strokeLinecap="round" fill="none"/>
    </svg>
  )
}
      ...
      <nav style={{ position:'sticky', top:0, zIndex:100, background: scrolled?'rgba(253,250,243,.97)':'transparent', backdropFilter:scrolled?'blur(12px)':'none', borderBottom:scrolled?'1px solid #DDE4EF':'none', padding:'0 5%', transition:'all .3s' }}>
        <div style={{ maxWidth:1160, margin:'0 auto', display:'flex', alignItems:'center', justifyContent:'space-between', height:62 }}>
          <div style={{ display:'flex', alignItems:'center', gap:10 }}>
            <div style={{ width:34, height:34, borderRadius:8, overflow:'hidden', background:'linear-gradient(135deg,#12382A,#071610)', flexShrink:0, display:'flex', alignItems:'center', justifyContent:'center' }}><LogoMark size={34}/></div>
            <div>
          ...
          <div className="footer-cols" style={{ display:'grid', gap:36, marginBottom:36 }}>
            <div>
              <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14 }}>
                <div style={{ width:30, height:30, borderRadius:7, overflow:'hidden', background:'linear-gradient(135deg,#12382A,#071610)', flexShrink:0, display:'flex', alignItems:'center', justifyContent:'center' }}><LogoMark size={30}/></div>
                <div>
